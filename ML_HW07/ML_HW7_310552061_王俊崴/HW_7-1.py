...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        ...
        TASK = sys.argv[1]
        X, X_filename, X_label = readData('D:/Speed_Lab/Course/ML/ML_HW07/Yale_Face_Database/Yale_Face_Database/Training')
        test, test_filename, test_label = readData('D:/Speed_Lab/Course/ML/ML_HW07/Yale_Face_Database/Yale_Face_Database/Testing')
